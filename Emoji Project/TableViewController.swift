...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.changeModel(object: object)
    ...
    @IBAction func unwindSegue(_ segue: UIStoryboardSegue) {
        ...
        let naviVC = segue.source as! UINavigationController
        let source = naviVC.topViewController as! NewEmojiViewController
        let newEmoji = source.emojiCopy
        let indexPath = IndexPath(row: cells.count, section: 0)
        tableView.insertRows(at: [indexPath], with: .left)
        cells.append(newEmoji!)
